...
import {
  ...
  SetArrivalTimePropsSchema,
  type CalculateOptimBaseGrossAmountParams,
  type DoDayUseParams,
  type SetHbPreferenceProps,
  type SetDepartureTimeProps,
  type VoidPaymentProps,
  type RoomsToProcessResult,
  type CalculateExclusiveTaxProps,
  type AckExposedRevisionProps,
  type ExposedGuests,
  type GetBookingInvoiceInfoProps,
  type GetRoomsToCheckInProps,
  type GetRoomsToCheckOutProps,
  type IssueInvoiceProps,
  type PrintInvoiceProps,
  type VoidInvoiceProps,
  type SetArrivalTimeProps,
} from './types';
...
export class BookingService {
  ...
  public async setArrivalTime(props: SetArrivalTimeProps) {
  ...
  public async doDayUse(params: DoDayUseParams) {
