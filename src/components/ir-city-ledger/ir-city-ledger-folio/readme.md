...
| -------------------- | ----------- | --------------------------- |
| `folioSummaryUpdate` |             | `CustomEvent<FolioSummary>` |
...
- [ir-city-ledger-folio-filters](ir-city-ledger-folio-filters)
- [ir-city-ledger-folio-table](ir-city-ledger-folio-table)
- [ir-dialog](../../ui/ir-dialog)
- [ir-custom-button](../../ui/ir-custom-button)
- [ir-city-ledger-transaction-drawer](ir-city-ledger-transaction-drawer)
...
graph TD;
  ...
  style ir-city-ledger-folio fill:#f9f,stroke:#333,stroke-width:4px
```
