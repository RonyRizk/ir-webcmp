...
| `emitOnSameValue`    | `emit-on-same-value`   | Emits `combobox-change` even when the selected value does not change.                                                                                                                                                                                                                  | `boolean`                                                                                                                                                            | `true`      |
...
| `inputClass`         | `input-class`          | Custom CSS classes applied to the inner `<ir-input>` element.  You can also target the exposed parts `::part(input)` and `::part(base)` for deeper styling of the native input and container.                                                                                          | `string`                                                                                                                                                             | `undefined` |
...
| `name`               | `name`                 | Name attribute forwarded to the underlying input element.                                                                                                                                                                                                                              | `string`                                                                                                                                                             | `undefined` |
| `open`               | `open`                 | Whether the autocomplete dropdown is open.                                                                                                                                                                                                                                             | `boolean`                                                                                                                                                            | `false`     |
...
| `placement`          | `placement`            | Placement of the autocomplete dropdown relative to the input.                                                                                                                                                                                                                          | `"bottom" \| "bottom-end" \| "bottom-start" \| "left" \| "left-end" \| "left-start" \| "right" \| "right-end" \| "right-start" \| "top" \| "top-end" \| "top-start"` | `'bottom'`  |
...
| ----------------- | ----------- | --------------------- |
| `combobox-change` |             | `CustomEvent<string>` |
