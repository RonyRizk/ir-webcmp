...
| `type`                    | `type`                      | Input type (e.g., text, password, email)                                                                                                                                                                                                        | `"number" \| "search" \| "file" \| "email" \| "date" \| "text" \| "month" \| "week" \| "button" \| "time" \| "password" \| "reset" \| "color" \| "url" \| "hidden" \| "image" \| "submit" \| "datetime-local" \| "tel" \| "checkbox" \| "range" \| "radio"` | `'text'`    |
