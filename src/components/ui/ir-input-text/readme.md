...
| `type`                    | `type`                      | Input type (e.g., text, password, email)                                                                                                                                                                                                        | `"number" \| "search" \| "file" \| "email" \| "date" \| "password" \| "text" \| "month" \| "week" \| "button" \| "time" \| "reset" \| "color" \| "url" \| "hidden" \| "tel" \| "image" \| "submit" \| "datetime-local" \| "checkbox" \| "range" \| "radio"` | `'text'`    |
