...
| `type`                    | `type`                      | Input type (e.g., text, password, email)                                                                                                                                                                                                        | `"number" \| "search" \| "file" \| "email" \| "date" \| "password" \| "month" \| "week" \| "text" \| "button" \| "time" \| "reset" \| "color" \| "url" \| "image" \| "submit" \| "datetime-local" \| "tel" \| "checkbox" \| "range" \| "hidden" \| "radio"` | `'text'`    |
