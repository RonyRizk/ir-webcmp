...
graph TD;
  ...
  ir-uninvoiced-bookings --> ir-booking-details-drawer
  ...
  ir-secure-tasks --> ir-uninvoiced-bookings
  style ir-uninvoiced-bookings fill:#f9f,stroke:#333,stroke-width:4px
```
